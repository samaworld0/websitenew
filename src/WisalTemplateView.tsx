...
100%{opacity:1;transform:translateY(0)}
      ...
      <div
        className="absolute inset-0 overflow-y-auto overflow-x-hidden z-10 royal-scroll flex justify-center items-start"
        style={{ WebkitOverflowScrolling: "touch", touchAction: "pan-y" }}
      >
        <div
          className={`relative transition-all duration-1000 w-full max-w-[560px] flex flex-col md:shadow-[0_0_60px_rgba(0,0,0,0.12)] ${
      ...
      {overlayMounted && (
        ...
        >
          {/* نفس عرض بطاقة المحتوى (max-w-[560px]) حتى فيديو الفتح يطلع
              متناسق مع باقي الصفحة على الشاشات الكبيرة (كمبيوتر/تابلت)،
              بدل ما يمتد الفيديو وحده على عرض الشاشة كاملة بينما باقي
              الصفحة بعرض بطاقة أضيق */}
          <div className="relative w-full h-full max-w-[560px] mx-auto overflow-hidden">
            <video
              ref={videoRef}
              muted
              playsInline
