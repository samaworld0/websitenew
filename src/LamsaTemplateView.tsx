        ...
        >
          ...
          >
            ...
            <div className="relative z-20 w-full max-w-3xl mx-auto px-5 py-6 flex flex-col justify-between h-full min-h-screen">
              ...
              <div className="my-auto flex flex-col items-center text-center">
                ...
                <h1 className="text-6xl md:text-8xl text-white mb-1 leading-none lamsa-ruqaa drop-shadow-2xl">
                  {inv.groom}
                </h1>
                <span className="text-3xl text-[#C9A227] my-3 lamsa-ruqaa">
                  و
                </span>
                <h1 className="text-6xl md:text-8xl text-white mt-1 leading-none lamsa-ruqaa drop-shadow-2xl">
                  {inv.bride}
                </h1>
                <div className="mt-8 space-y-2">
                  <p className="text-xl md:text-2xl text-[#FDF6F2] lamsa-amiri">
                    {inv.dateGreg}
                  </p>
          ...
          <div className="w-full bg-[#FBF3EF] text-[#3D2B2E] relative z-20">
            <section className="py-24 px-6 flex flex-col items-center">
              <div className="text-center max-w-xl mb-20 lamsa-reveal">
                <p className="text-base tracking-widest text-[#8C6B6F] mb-5 lamsa-eyebrow">
                  بِسْمِ اللَّهِ الرَّحْمَٰنِ الرَّحِيمِ
                </p>
                <p className="text-xl md:text-2xl leading-loose text-[#5A3B3F] lamsa-amiri">
                  {inv.verse}
                </p>
                <div className="mt-5 text-[#C9A227] text-lg">✦</div>
              </div>

              <div className="w-28 h-[1px] bg-[#C9A227]/30 mb-20" />

              <div className="text-center max-w-lg mb-20 lamsa-reveal">
                <h3 className="text-3xl md:text-4xl font-bold text-[#4A2B32] mb-7 lamsa-heading">
                  دعوة خطوبة
                </h3>
                <p className="text-lg md:text-xl leading-relaxed text-[#5A3B3F] mb-2 lamsa-tajawal">
                  بقلوب مفعمة بالفرح والامتنان، يسعدنا دعوتكم لمشاركتنا حفل
                  خطوبتنا ولحظة بداية طريقنا الجديد. حضوركم يزيد فرحتنا
                  ويكمّلها.
                </p>
              </div>
              ...
              <div className="text-center w-full max-w-lg mb-16 lamsa-reveal">
                ...
                >
                  <div className="flex flex-col items-center bg-white border border-[#C9A227]/30 rounded-2xl px-5 py-4 shadow-sm min-w-[85px]">
                    ...
                    <span className="text-sm text-[#8C6B6F] mt-1">ثانية</span>
                  </div>
                  <div className="flex flex-col items-center bg-white border border-[#C9A227]/30 rounded-2xl px-5 py-4 shadow-sm min-w-[85px]">
                    <span className="text-3xl font-bold text-[#4A2B32] lamsa-heading">
                      {String(timeLeft.minutes).padStart(2, "0")}
                    </span>
                    <span className="text-sm text-[#8C6B6F] mt-1">دقيقة</span>
                  </div>
                  <div className="flex flex-col items-center bg-white border border-[#C9A227]/30 rounded-2xl px-5 py-4 shadow-sm min-w-[85px]">
                    <span className="text-3xl font-bold text-[#4A2B32] lamsa-heading">
                      {String(timeLeft.hours).padStart(2, "0")}
                    </span>
                    <span className="text-sm text-[#8C6B6F] mt-1">ساعة</span>
                  </div>
                  <div className="flex flex-col items-center bg-white border border-[#C9A227]/30 rounded-2xl px-5 py-4 shadow-sm min-w-[85px]">
                    <span className="text-3xl font-bold text-[#4A2B32] lamsa-heading">
                      {timeLeft.days}
                    </span>
                    <span className="text-sm text-[#8C6B6F] mt-1">يوم</span>
                  </div>
                </div>
              </div>
            </section>
            ...
            <section className="py-20 px-6 flex flex-col items-center bg-[#5C2A38] text-[#F5E9E4] border-t-2 border-[#C9A227]">
              <div className="text-center max-w-lg w-full mb-24 lamsa-reveal">
                ...
                <div className="space-y-7 text-base md:text-lg text-[#F5E9E4] lamsa-tajawal">
                  <div className="flex justify-between items-center border-b border-[#C9A227]/20 pb-5">
                    <span className="font-bold text-[#F1D4B8]">٦:٠٠ مساءً</span>
                    <div className="flex-1 border-b border-dashed border-[#C9A227]/30 mx-4" />
                    <span>استقبال الضيوف</span>
                  </div>
                  <div className="flex justify-between items-center border-b border-[#C9A227]/20 pb-5">
                    <span className="font-bold text-[#F1D4B8]">٦:٣٠ مساءً</span>
                    <div className="flex-1 border-b border-dashed border-[#C9A227]/30 mx-4" />
                    <span>حفل الخطوبة وتقديم الشبكة</span>
                  </div>
                  <div className="flex justify-between items-center border-b border-[#C9A227]/20 pb-5">
                    <span className="font-bold text-[#F1D4B8]">٨:٠٠ مساءً</span>
                    <div className="flex-1 border-b border-dashed border-[#C9A227]/30 mx-4" />
                    <span>الحلوى والتهنئة</span>
                  </div>
                </div>
              </div>
