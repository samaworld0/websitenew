          ...
          >
            ...
            <div className="relative z-20 w-full max-w-3xl mx-auto px-5 py-6 flex flex-col justify-between h-full min-h-screen">
              ...
              <div className="my-auto flex flex-col items-center text-center">
                ...
                <h1 className={`${getNameFontSizeClass(inv.nameFontSize, "md")} text-white mb-1 leading-none lamsa-ruqaa drop-shadow-2xl`}>
                  {inv.groom}
                </h1>
                <span className="text-3xl text-[#C9A227] my-3 lamsa-ruqaa">
                  و
                </span>
                <h1 className={`${getNameFontSizeClass(inv.nameFontSize, "md")} text-white mt-1 leading-none lamsa-ruqaa drop-shadow-2xl`}>
                  {inv.bride}
                </h1>
