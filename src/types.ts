export interface Invitation {
  ...
  // تعديل محتوى نص عنصر معيّن (نص بديل عن النص الافتراضي المكتوب
  // بالكود، مثل "فتحنا باب فرحتنا..." أو "بطاقة دعوة") — كل مفتاح هو
  // نفس معرّف العنصر المستخدم بـ textStyles. العناصر اللي ما إلها
  // مفتاح هنا تستمر تعرض نصها الافتراضي.
