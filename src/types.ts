...
export interface Invitation {
  ...
  // لو مفعّل، الضيف يوصل مباشرة لمحتوى الدعوة بدون شاشة "اضغط لفتح
  // الدعوة" ولا فيديو/حركة الفتح — الدعوة تفتح مباشرة زي ما لو ضغط
  // عليها فوراً. مفيد لمن ما يريد الخطوة هذي أصلاً بدعوته.
