...
export interface Invitation {
  ...
  // أحجام خطوط مخصّصة لنصوص معيّنة داخل الدعوة (بالبكسل) — يعبّيها محرر
  // التصميم المباشر (شبيه فيغما) لما الأدمن يسحب مقبض التكبير/التصغير
  // تحت أي نص. المفتاح هو معرّف النص (مثل groomName) والقيمة حجم الخط.
